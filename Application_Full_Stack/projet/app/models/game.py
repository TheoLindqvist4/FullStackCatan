...
class CatanInterface:
    def __init__(self, board):
        self.board = board
        self.root = None  # Initialize root as None for headless mode handling
    ...
    def setup_ui(self):
        ...
        self.resource_images = {
            'Brick': "projet/app/images/tiles/brick.png",
            'Sheep': "projet/app/images/tiles/sheep.png",
            'Ore': "projet/app/images/tiles/stone.png",
            'Weat': "projet/app/images/tiles/weat.png",
            'Wood': "projet/app/images/tiles/wood.png",
            'Desert': "projet/app/images/tiles/desert.png"
        }
        self.number_images = {
            2: "projet/app/images/images/numbers/2.png",
            3: "projet/app/images/images/numbers/3.png",
            4: "projet/app/images/images/numbers/4.png",
            5: "projet/app/images/images/numbers/5.png",
            6: "projet/app/images/images/numbers/6.png",
            8: "projet/app/images/images/numbers/8.png",
            9: "projet/app/images/images/numbers/9.png",
            10: "projet/app/images/images/numbers/10.png",
            11: "projet/app/images/images/numbers/11.png",
            12: "projet/app/images/images/numbers/12.png"
        }

        # Load images and create the board
        self.load_images()
        self.create_board()
    ...
    def load_images(self):
        ...
        self.num_imgs = {
            num: ImageTk.PhotoImage(Image.open(path).resize((50, 50), Image.LANCZOS))
